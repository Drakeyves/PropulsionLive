...
-- Set default values separately
ALTER TABLE profiles ALTER COLUMN membership_tier SET NOT NULL;
ALTER TABLE profiles ALTER COLUMN membership_tier SET DEFAULT 'initiates';
